...
-(void) scoreTimerSec2
{
	...
	[scoreDefaults2 setInteger: time forKey:@"bestTime"];
...
-(void) gameUpdate2
{
	...
	else if(myDog.center.x <= 0)
	{
		...
		{
			resetDogTimer = [NSTimer scheduledTimerWithTimeInterval:1 target:self selector:@selector(resetDog) userInfo:nil repeats:NO];
		}
	}
